...
<<<<<<< HEAD
		...
		<div class="container">
			<header class="clearfix">
				...
				<span><a href="/tama/tlist?theme=${themeA}" style="color: #ff69b4;">　←スレッド一覧</a></span>
				<h1>${name}</h1>
=======
		<!--謚慕ｨｿ逕ｻ髱｢縺ｮ繧ｿ繧､繝�繝ｩ繧､繝ｳ-->
		<div class="container">
			<header class="clearfix">
				<span><a href="Thread.html" style="color: #ff69b4;">竊舌せ繝ｬ繝��ラ荳�隕ｧ</a></span>
				<h1>THREAD蜷�</h1>
>>>>>>> 1219d91de1a49289f4c01c66ecabf51106f4348d
				<nav>
...
=======
		<!--謚慕ｨｿ逕ｻ髱｢繝ｻTL謚慕ｨｿ邱ｨ髮�-->
		<div class="Toukou" style="width: 350px; height: 350px;">
			<form method='post' action='' style="width: 300px; height: 300px; ">		<!--form縺ｮJava蜿ら��繝代せ繧呈欠螳�-->
				蜷榊燕:<br><input type="text" name="name"  value=""><br>
				繧ｿ繧､繝医Ν:<br><input type="text" name="name"  value=""><br>
			    譛ｬ譁�:<br><textarea name="message" class="honbun" name="honbun" cols="30" rows="10" minlength="" wrap="hard" placeholder="300蟄嶺ｻ･蜀��〒蜈･蜉帙＠縺ｦ縺上□縺輔＞縲�"></textarea><br>
				<br><a class="button" input type="submit" href="#">縺､縺ｶ繧��￥！</a>
>>>>>>> 1219d91de1a49289f4c01c66ecabf51106f4348d
			</form>
		</div>
	</div>
...
=======
			.Rog{	/* 繝ｼ繝ｼ繝ｼ繧ｿ繧､繝�繝ｩ繧､繝ｳ遽��峇謖��ｮ壹��繝ｼ繝ｼ */
>>>>>>> 1219d91de1a49289f4c01c66ecabf51106f4348d
			top: 100px;
			left: 2%;
			width: 50%;
...
=======
			.Toukou{	/* 繝ｼ繝ｼ繝ｼ謚慕ｨｿ縺ｮ遽��峇謖��ｮ壹��繝ｼ繝ｼ */
>>>>>>> 1219d91de1a49289f4c01c66ecabf51106f4348d
			top: 40%;
			left: 80%;
			float:left;
